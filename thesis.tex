...
% introduce table
Table \ref{table:companies} introduces detailed information of the companies researched in this thesis. Two of the companies are listed in OMX Nordic Helsinki, two in OMX Nordic Stockholm and one is listed in OMX Nordic Copenhagen exchanges, hence all the biggest northern European stock exchanges are 
covered.
...
\textbf{QUESTION:} Is this information too basic to be included? Should I just assume reader knows this kind of information or just add necessary financial terms into glossary and write shorter introductory?
...
% this study is about stock markets

% type of orders in equity markets
...
Other order types are also available in OMX Markets but everything stems from these two kinds of orders.
