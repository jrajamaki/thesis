...
% WRONG PLACE??
%The research will utilise trading data to detect and identify spoof trading, and then use regular stock market behaviour as a benchmark to estimate how spoof trading differs.

% existance -> examination
